...
F-026–F-030 were discovered at G-003 after direct user review of EXP-008. They are validation-discovered classes, not retroactively claimed historical incidents. The EXP-008 package itself remains private and rejected; sanitized findings are recorded in the reference-case experiment and retest protocol.
